                    ...
                    <div class="card-body">
                      <h4 class="card-title">Edit user</h4>
                        ...
                        <div class="form-group{{ $errors->has('user_id') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="user_id" value="{{ $data->user_id}}" required>
                       ...
                       <!--  <div class="form-group">
                        ...
                        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="password" type="password" class="form-control" onkeyup='check();' name="password" value="" required>
